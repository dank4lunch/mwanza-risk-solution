...
export default function About() {
  ...
  const features = [
    {
      ...
      description:
        "Comprehensive range of insurance solutions covering all aspects of personal and commercial risks.",
    },
    {
      icon: Globe,
      title: "Local and Continental Insight",
      description:
        "Deep understanding of South African and African markets with over 20 years of local expertise.",
    },
    {
      icon: Heart,
      title: "Client-Centric Approach",
      description:
        "Every solution is tailored to meet the unique needs and challenges of our clients.",
    },
    {
      icon: Award,
      title: "Commitment to Excellence",
      description:
        "Unwavering dedication to providing the highest quality service and professional expertise.",
    },
  ];
  ...
  const stats = [
    ...
    },
    {
      icon: FileText,
      value: "3500+",
      label: "Tailored Insurance Policies Delivered",
      color: "text-purple-500",
    },
    {
      icon: Heart,
      value: "100%",
      label: "Commitment to Personalized Service",
      color: "text-red-500",
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "We believe that effective risk management begins with understanding human behavior. By analyzing decisions, actions, and patterns, we develop proactive strategies to prevent risks before they escalate.",
    },
    {
      icon: Target,
      title: "Tailored Solutions",
      description:
        "Every client receives customized insurance solutions designed to meet their specific needs and risk profile.",
    },
    {
      icon: Crown,
      title: "100% Black-Owned",
      description:
        "Proudly South African and 100% Black-owned, we understand the unique challenges and opportunities in our market.",
    },
    {
      icon: Handshake,
      title: "Your Partner in Managing Risk",
      description:
        "We don't just provide insurance; we partner with you to understand, assess, and manage your risks comprehensively.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8 leading-relaxed">
                Mwanza Risk Solution is a leading professional services firm
                specializing in short term insurance and risk management
                dedicated to providing professional services and innovative
                solutions. With over 15 years of experience in both commercial
                and domestic insurance, our expertise spans a wide range of
                industries, helping businesses and individuals navigate the
          ...
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-gray-200 mb-6 leading-relaxed">
                We believe that effective risk management begins with a deep
                understanding of human behavior. It's not just about identifying
                potential risks; it's about recognizing the decisions, actions,
                and patterns that contribute to those risks.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                By carefully analyzing behavior, we can better predict potential
                vulnerabilities and develop proactive strategies to address
                them. This approach allows us to anticipate and mitigate risks
                before they escalate, ensuring our clients are not only
                protected from foreseeable dangers but also from unexpected
                challenges. At Mwanza Risk Solution, we don't just react to
                risks—we work with you to prevent them from occurring, keeping
                you one step ahead of the uncertainties in today's ever-changing
                world.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="bg-gradient-to-br from-brand-navy-light/50 to-brand-navy-dark/50 border-blue-500/20 hover:border-blue-400/40 transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-200 text-lg leading-relaxed">
                  To establish ourselves as a leading global professional
                  services firm, offering a comprehensive range of risk
                  solutions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-brand-navy-light/50 to-brand-navy-dark/50 border-blue-500/20 hover:border-blue-400/40 transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-200 text-lg leading-relaxed">
                  Our mission is to empower our clients through tailored
                  insurance solutions and expert risk management services. We
                  are committed to offering comprehensive coverage that protects
                  everything from commercial property and machinery to personal
                  belongings and leisure assets. Our goal is to ensure that
                  every client's needs are met with the highest level of
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Choosing Mwanza Risk Solution means choosing a partner who is
              dedicated to your success. We don't just offer insurance; we offer
              peace of mind, knowing that your risks are managed with expertise,
              dedication, and a deep understanding of your specific needs.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <Card
                key={index}
                className="group hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-2 bg-brand-navy/50 border-blue-500/20"
              >
                <CardContent className="p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-6 leading-relaxed">
                At Mwanza Risk Solution, we specialize in providing professional
                insurance broking and risk management services tailored to meet
                the unique needs of our clients.
              </p>
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                With over 20 years of experience in both commercial and domestic
                insurance, we understand the complexities and challenges
                businesses face in South Africa and across the African
                continent.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-200">
                    Authorised National Credit Provider NCRCP20076
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary" />
                  <span className="text-gray-200">
                    Authorised Financial Services Provider FSP 47505
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary" />
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary" />
                  <span className="text-gray-200">
                    Comprehensive Local and Continental Coverage
                  </span>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-brand-blue via-brand-blue-dark to-brand-navy relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied clients who trust Mwanza Risk Solution
            for their insurance needs. Contact us today for personalized
            service.
          </p>
