...
const movingButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden group cursor-pointer",
  {
    variants: {
      variant: {
        primary: "bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white shadow-2xl hover:shadow-purple-500/50 transform-gpu perspective-1000 hover:rotate-y-12 hover:rotate-x-6 hover:scale-110 active:scale-95 before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/0 before:via-white/30 before:to-white/0 before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-1000 before:skew-x-12",
        glowing: "bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 text-white shadow-2xl shadow-cyan-500/50 hover:shadow-cyan-400/70 animate-pulse hover:animate-none hover:scale-110 hover:rotate-3 active:scale-95 before:absolute before:inset-0 before:bg-gradient-conic before:from-cyan-400/20 before:via-transparent before:to-purple-600/20 before:animate-spin before:duration-2000",
        ...
        rainbow: "bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 via-blue-500 via-indigo-500 to-purple-500 text-white shadow-2xl hover:shadow-rainbow animate-gradient-x hover:scale-110 hover:rotate-y-6 active:scale-95 before:absolute before:inset-0 before:bg-gradient-to-45 before:from-white/0 before:via-white/40 before:to-white/0 before:translate-x-[-100%] before:translate-y-[-100%] hover:before:translate-x-[100%] hover:before:translate-y-[100%] before:transition-transform before:duration-800",
        floating: "bg-gradient-to-tr from-purple-400 via-pink-500 to-red-500 text-white shadow-2xl shadow-purple-500/40 hover:shadow-pink-500/60 animate-float hover:animate-none hover:scale-110 hover:rotate-y-12 active:scale-95",
      },
      size: {
